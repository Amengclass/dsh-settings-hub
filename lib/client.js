...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function buildPluginSectionMap() {
			...
			const manifest = (window.__DSH_MODULES__ || {}).manifest;
			console.log("[dsh-settings-hub] manifest:", manifest);
			console.log("[dsh-settings-hub] manifest.plugins:", manifest && manifest.plugins);
